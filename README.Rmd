...
- A reproducible workflow can be found at the [RGLab site](http://www.rglab.org/CytoML), and was prepared with the release version of CytoML and its dependencies that can be installed by:
...
The matrix of expression can be extracted from a `flowFrame` using the `exprs()` method:
